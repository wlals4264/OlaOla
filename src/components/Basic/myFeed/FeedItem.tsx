  ...
  return (
    <div className="flex px-10 py-6">
      ...
      <div className="w-[360px]">
        ...
        <div className="w-[300px] border-t-[0.5px] border-solid border-gray-500"></div>
        <div className="w-[300px] mt-2 flex gap-4 items-center justify-between">
          {/* 좋아요 버튼 */}
        ...
        <form className="w-[300px] relative">
          <input type="text" placeholder="댓글을 남겨주세요!" className="w-full" />
          <svg
